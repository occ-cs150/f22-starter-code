...
// The following function has already been written
// and included in the library. You will CALL the
// function when writing composite, but you will
// NOT reimplement it or your code will not link.
/**
